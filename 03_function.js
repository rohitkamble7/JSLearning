...
console.log("====== Function type:function with arguments and no return type ===== ");
console.log("==== swap ========");
...
console.log("Refer code below for practise");
...
console.log("Num is 10 and its square is: ", square);
