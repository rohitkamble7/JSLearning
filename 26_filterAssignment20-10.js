...
class Employee {
    ...
    const EmpFromTCS =arrayEmployee.filter((currentValue)=>{
...
return currentValue.emp_company=="TCS";
    ...
    EmpFromTCS.forEach((currentValue)=>{


       console.log(`Company Name: ${currentValue.emp_company} || Employee Name: ${currentValue.emp_name}`);
    })
   

    console.log(`--------------------------------------------------------------`);

    const empWipro = arrayEmployee.filter((currentValue) => {

        return currentValue.emp_company=="Wipro"

    })

    const empSalary =empWipro.map((currentValue)=> {
...
const empWiInfy= arrayEmployee.filter((currentValue)=>{
